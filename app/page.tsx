...
<a
  href="#"
  className="block transition-opacity duration-500 mix-blend-difference hover:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white md:absolute md:left-8 lg:left-10 min-[1600px]:fixed min-[1600px]:left-16 min-[1600px]:top-2"
  aria-label="MUSUBI"
>
<Image
  ...
  width={595}
  height={595}
  className="h-14 w-auto -translate-x-4 invert md:h-20 md:translate-x-0"
/>
</a>

  <button
    type="button"
    className="ml-auto flex h-11 w-11 translate-x-2 items-center justify-center rounded-full border border-white/20 bg-black/20 text-white transition-all duration-300 hover:border-white/45 hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white md:hidden"
