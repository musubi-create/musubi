...
<a
  href="#"
  className="block transition-opacity duration-500 mix-blend-difference hover:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white md:fixed md:left-[calc(4.3vw+27px)] md:top-2"
  aria-label="MUSUBI"
>
<Image
  ...
  width={595}
  height={595}
  className="h-14 w-auto -translate-x-4 invert md:h-20 md:-translate-x-[23.5px]"
/>
</a>
